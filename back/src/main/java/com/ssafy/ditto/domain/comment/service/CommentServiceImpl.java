...
public class CommentServiceImpl implements CommentService {
    ...
    @Override
    @Transactional
    public String writeComment(int postId, CommentRequest commentReq) throws Exception {
...
//            commentResp.setUserId(comment.getUserId());
//            commentResp.setUsername(comment.getUserId());
            ...
            if(comment.getParent() == null) responseList.add(commentResp);
                ...
                parent.get(comment.getParent().getCommentId())
                        .getChildren().add(commentResp);
            }
        }
        return responseList;
    }
    ...
    @Override
    public String modifyComment(int commentId, CommentRequest commentReq) throws Exception {
    ...
    public Comment findRootComment(Comment child) throws Exception {
        if(child.getParent() == null) return child;
        return findRootComment(child.getParent());
    }

    public void deleteRootComment(Comment comment) throws Exception {
    ...
    public int countNotRemovedChild(Comment parent) throws Exception {
    ...
    public String checkRemoved(Comment comment) throws Exception {

...
public class ProfileController {
    ...
    public ResponseDto<Boolean> checkLikeUser(@Parameter(description = "유저 ID", example = "1") @PathVariable("userId") int userId, @Parameter(description = "확인할 유저 ID", example = "2") @RequestParam("seekerId") int seekerId) {
    ...
    public ResponseDto<String> addLikeUser(@Parameter(description = "유저 ID", example = "1") @PathVariable("userId") int userId, @Parameter(description = "좋아요할 유저 ID", example = "2") @RequestParam("seekerId") int seekerId) {
    ...
    public ResponseDto<String> removeLikeUser(@Parameter(description = "유저 ID", example = "1") @PathVariable("userId") int userId, @Parameter(description = "삭제할 유저 ID", example = "2") @RequestParam("seekerId") int seekerId) {

...
CREATE TABLE `mileage` (
  ...
  `mileage_id` int NOT NULL AUTO_INCREMENT,
  `user_id` int DEFAULT NULL,
  PRIMARY KEY (`mileage_id`),
  UNIQUE KEY `UKs6nuljl2xxw684h2ms89lulw4` (`user_id`),
...
INSERT INTO `mileage` VALUES (0,2,1),(42936,3,4),(38000,4,5),(0,5,6),(0,6,7),(0,7,8),(0,8,9),(102000,9,10),(135000,10,11),(80000,11,12),(519246,12,23),(0,13,27),(10000,14,25),(0,15,28);

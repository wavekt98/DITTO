...
const Ball = styled.div`
  ...
  height: 20px;
  border-radius: 50%;
  animation: ${bounceAnimation} ${({ duration }) => duration || "1.5s"} ease-in-out infinite;
...
function NoContentPage() {
  return (
    <Container>
      <NoContentMessage>죄송합니다. 해당 페이지를 찾을 수 없습니다.</NoContentMessage>
      <BallsContainer>
        <Ball color="#FF4500" delay="0s" duration="1.5s" /> {/* Orange */}
        <Ball color="#FF6347" delay="0.3s" duration="1.6s" /> {/* Dark Orange */}
